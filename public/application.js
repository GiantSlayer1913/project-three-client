...
var onSignUp = function onSignUp(event) {
  ...
  api.signUp(data).then(ui.signUpSuccess).then(function () {
    return onAutoSignIn(data);
  }).catch(ui.signUpFailure);
};

var onAutoSignIn = function onAutoSignIn(data) {
...
var onSignOut = function onSignOut(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.signOut(data).then(ui.signOutSuccess)
...
var onCreateTodo = function onCreateTodo(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  store.data = data;
  // console.log('data is: ', data)
  api.createTodo(data).then(ui.createSuccess).then(function () {
    return onGetMyTodos();
  }).catch(ui.createFailure);
};

var onGetMyTodos = function onGetMyTodos() {
  api.getTodos().then(ui.getMyTodosSuccess).catch(ui.getMyTodosFailure);
};

var onCompletedTodos = function onCompletedTodos(event) {
  event.preventDefault();
  api.getCompletedTodos().then(ui.getMyCompletedTodosSuccess).catch(ui.getMyCompletedTodosFailure);
};

var onDestroyTodo = function onDestroyTodo(event) {
  event.preventDefault();
  var todoId = $(event.target).closest('button').attr('data-id');
  // console.log(todoId)
  api.destroyTodo(todoId).then(ui.destroyTodoSuccess).then(function () {
    return onGetMyTodos(event);
  }).catch(ui.destroyTodoFailure);
};

var onCompletedDestroyTodo = function onCompletedDestroyTodo(event) {
  event.preventDefault();
  var todoId = $(event.target).closest('button').attr('data-id');
  // console.log(todoId)
  api.destroyTodo(todoId).then(ui.destroyCompletedTodoSuccess).then(function () {
    return onCompletedTodos(event);
  }).then(function () {
    return onGetMyTodos(event);
  }).catch(ui.destroyCompletedTodoFailure);
};

var onUpdateTodo = function onUpdateTodo(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var todoId = $(event.target).closest('div').attr('data-id');
  api.updateTodo(data, todoId).then(ui.updateTodoSuccess).then(function () {
    return onGetMyTodos(event);
  }).catch(ui.updateTodoFailure);
};

var onCompleteTodo = function onCompleteTodo(event) {
  event.preventDefault();
  var todoId = $(event.target).closest('button').attr('data-id');
  api.completeTodo(todoId).then(ui.completeTodoSuccess).then(function () {
    return onGetMyTodos(event);
  }).catch(ui.completeTodoFailure);
};

var onBackOnListTodo = function onBackOnListTodo(event) {
  event.preventDefault();
  var todoId = $(event.target).closest('button').attr('data-id');
  api.backOnListTodo(todoId).then(ui.backOnListSuccess).then(function () {
    return onCompletedTodos(event);
  }).then(function () {
    return onGetMyTodos(event);
...
var onPublicTodos = function onPublicTodos(event) {
  event.preventDefault();
  api.getCompletedTodos().then(ui.getPublicTodosSuccess).catch(ui.getPublicTodosFailure);
};
...
var getCompletedTodos = function getCompletedTodos() {
  return $.ajax({
    url: config.apiUrl + '/todos/',
    method: 'GET',
    headers: {
...
var updateTodo = function updateTodo(data, todoId) {
  return $.ajax({
...
var backOnListTodo = function backOnListTodo(todoId) {
  return $.ajax({
    url: config.apiUrl + '/todos/' + todoId,
    method: 'PATCH',
    headers: {
...
var destroyTodo = function destroyTodo(todoId) {
  return $.ajax({
    url: config.apiUrl + '/todos/' + todoId,
    method: 'DELETE',
    headers: {
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://rocky-falls-93559.herokuapp.com',
...
var showMyTodosTemplate = __webpack_require__(15);
var showMyTodosCompleteTemplate = __webpack_require__(32);
var showPublicTodos = __webpack_require__(33);
...
var signUpFailure = function signUpFailure() {
  ...
  setTimeout(function () {
    return $('.failedmessage1').text('Failed to Sign Up');
  }, 300);
};
...
var getMyTodosSuccess = function getMyTodosSuccess(data) {
  var myTodos = [];
  data.todos.forEach(function (el) {
  ...
  // console.log(myTodos)
  var showTodosHtml = showMyTodosTemplate({
    todos: myTodos
...
var getMyCompletedTodosSuccess = function getMyCompletedTodosSuccess(data) {
  // console.log(data)
  var myTodos = [];
  data.todos.forEach(function (el) {
    if (el.owner._id === store.user._id) {
  ...
  // console.log(myTodos)
  var showTodosHtml = showMyTodosCompleteTemplate({
    todos: myTodos
    // .sort(function (a, b) {return b.id - a.id})
  });
...
var getMyTodosFailure = function getMyTodosFailure() {
  $('.failedmessage4').text('Sorry, but your list is not available at the moment');
  setTimeout(function () {
    return $('.failedmessage4').text('');
  }, 5000);
};

var getMyCompletedTodosFailure = function getMyCompletedTodosFailure() {
...
var updateTodoSuccess = function updateTodoSuccess() {
...
var updateTodoFailure = function updateTodoFailure() {
...
var completeTodoSuccess = function completeTodoSuccess() {
...
var completeTodoFailure = function completeTodoFailure() {
...
var backOnListSuccess = function backOnListSuccess() {
...
var backOnListFailure = function backOnListFailure() {
...
var destroyTodoSuccess = function destroyTodoSuccess() {
...
var destroyTodoFailure = function destroyTodoFailure() {
...
var destroyCompletedTodoSuccess = function destroyCompletedTodoSuccess() {
...
var destroyCompletedTodoFailure = function destroyCompletedTodoFailure() {
...
// BONUS FEATURE UI------------------------------------
var getPublicTodosSuccess = function getPublicTodosSuccess(data) {
  // console.log(data)
  var publicTodos = [];
  data.todos.forEach(function (el) {
    publicTodos.unshift(el);
  });
  var showTodosHtml = showPublicTodos({
    todos: publicTodos
    // .sort(function (a, b) {return b.id - a.id})
  });
...
var getPublicTodosFailure = function getPublicTodosFailure() {
  $('.failedmessage5').text('Sorry, but the public list is not available at the moment');
  setTimeout(function () {
    return $('.failedmessage5').text('');
  }, 5000);
};
...
module.exports = {
  ...
  getMyTodosSuccess: getMyTodosSuccess,
  getMyTodosFailure: getMyTodosFailure,
  updateTodoSuccess: updateTodoSuccess,
  createSuccess: createSuccess,
  createFailure: createFailure,
  updateTodoFailure: updateTodoFailure,
  destroyTodoSuccess: destroyTodoSuccess,
  destroyTodoFailure: destroyTodoFailure,
  completeTodoFailure: completeTodoFailure,
  completeTodoSuccess: completeTodoSuccess,
  getMyCompletedTodosSuccess: getMyCompletedTodosSuccess,
  getMyCompletedTodosFailure: getMyCompletedTodosFailure,
  destroyCompletedTodoFailure: destroyCompletedTodoFailure,
  destroyCompletedTodoSuccess: destroyCompletedTodoSuccess,
  backOnListFailure: backOnListFailure,
  backOnListSuccess: backOnListSuccess,
  getPublicTodosSuccess: getPublicTodosSuccess,
  getPublicTodosFailure: getPublicTodosFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return " <!-- Template structure of db -->\n  <h3 data-id=\""
    ...
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.text : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</p>\n  </div>\n  <!-- Check mark -->\n  <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" class=\"complete\" type=\"submit\">Completed</button>\n  <!-- Explanation of update button -->\n  <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" data-toggle=\"modal\" data-target=\"#modalupdate"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" class=\"update\" type=\"submit\">Update</button>\n  <!-- Modal for update biutton -->\n  <div data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" class=\"modal\" id=\"modalupdate"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    ...
    + "\" class=\"modal-body\">\n              <form data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" class=\"updating-todo-form\">\n                <p>Title: <input required type=\"text\" name=\"todo[title]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
    + "\"></p>\n                <p>Place: <input required type=\"text\" name=\"todo[location]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.location : stack1), depth0))
    + "\"></p>\n                <textarea required type=\"text\" name=\"todo[text]\" maxlength=\"2000\" rows=\"4\" cols=\"50\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.text : stack1), depth0))
    + "</textarea>\n              </br><input class=\"update-success-button\" type=\"submit\" name=\"submit\" value=\"Update\">\n              </form>\n            </div>\n            <div class=\"modal-footer\">\n              <h2 class=\"failedmessage2 fm\"></h2>\n            </div>\n          </div>\n        </div>\n      </div>\n  <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" class=\"destroy\" type=\"submit\">Remove</button>\n\n";
  ...
  return "<h3 class=\"myHeader\">My Todo list</h3>\n<div id=\"myTodoContent\" class=\"content\" data-id=\""
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.todo : depth0)) != null ? stack1._id : stack1), depth0))
    + "\">\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.todos : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</div>\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return " <!-- Template structure of db -->\n  <h3 data-id=\""
    ...
    + "</p>\n  </div>\n  <!-- Check mark -->\n  <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" class=\"back-to-list\" type=\"submit\">Back on a list</button>\n  <!-- Explanation of update button -->\n  <!-- <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" data-toggle=\"modal\" data-target=\"#modalupdate1"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" class=\"update\" type=\"submit\">Update</button> -->\n  <!-- Modal for update biutton -->\n  <!-- <div data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" class=\"modal\" id=\"modalupdate1"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"modalLabel\">\n        <div data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" class=\"modal-dialog\" role=\"document\">\n          <div data-id=\""
  ...
  return "<div id=\"myCompletedContent\" class=\"content\" data-id=\""
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.todo : depth0)) != null ? stack1._id : stack1), depth0))
    + "\">\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.todos : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</div>\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div id=\"publicContent\" class=\"content\" data-id=\""
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.todo : depth0)) != null ? stack1._id : stack1), depth0))
    + "\">\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.todos : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</div>\n";
